...
console.log("Integer - Float");
let floaSubtraction = myFirstFloatVariable - myFirstIntegerVariable;
console.log(floaSubtraction);
console.log("~~~~~~~~");
...
//Dividing whole numbers results implicit integer
let x = 4/2;
console.log(x);
console.log("~~~~~~~~");

console.log("Modulus 6 & 2");
//Calcuate the remainder from a division
let modResult = 6 % 2;
